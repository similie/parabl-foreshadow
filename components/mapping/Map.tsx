/**
 * @similie
 * We ran into an issue with the MapView component from react-native-maps. Additionally, it didn't
 * support some of the features we needed, such as with active tile layers.
 * However, we maintained the commented code here for reference in case we need to revert back.
 *
 */
